...
class GrnController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        try {
            ...
            $grn->CoffeeTypeId = $validatedData['CleanTypeId'];
            ...
            $grn->PermitNo = $validatedData['permit_no'];
            $test = $grn->save();
            dd($e->getMessage());
    
            return redirect()->route('pages.blank.blank')->with('success', 'GRN created successfully!');
        } catch (\Exception $e) {
