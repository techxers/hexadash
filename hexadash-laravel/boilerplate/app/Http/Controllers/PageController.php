...
class PageController extends Controller {
    ...
    public function blank(){
        ...
        $description = "Some description for the page";
        $growers = Grower::all();
        $seasons = CoffeeSeason::all();
        $cleanTypes = CleanType::all();
        $agents = Agent::all();
        $users = User::all();
        $success = '';


        return view('pages.blank.blank',compact('title','description','growers','seasons','cleanTypes','agents','users','success'));
    }
