...
// implement grn.add
Route::post('/grn/add',[GrnController::class,'create'])->name('grn.add')->middleware('auth');
// \implement grn.search
Route::get('/grn/search',[GrnController::class,'search'])->name('grn.search')->middleware('auth');